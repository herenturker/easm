...
typedef enum
{
    ...
    INSTR_CLI,     /**< Clear Interrupts */
    INSTR_LOOP,    /**< Loop */
    INSTR_LODSB,   /**< Load string byte */
    ...
    // Assembler directives (tokens, treated separately but useful so I put here)
    ...
    DIRECTIVE_TIMES    /**< TIMES directive */
